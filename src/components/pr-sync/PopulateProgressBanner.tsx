...
// Phase 13 Wave 3C — sticky banner under the PR detail header while
// populate_status='running'. Auto-dismisses on done; offers Cancel.

import { Loader2, X } from "lucide-react";
import { useState } from "react";

import { cancelPrSync } from "@/lib/aiplatformkb-api";
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <span>
          Populating · ~${status.populate_cost_usd.toFixed(2)} spent
        </span>
      </div>
      <button
