...
// ai-platform replica of ForcePopulateButton.

import { Loader2, RefreshCw } from "lucide-react";
import { useEffect, useState } from "react";

import { triggerForcePopulate } from "@/lib/ai-platform-api";
...
export default function ForcePopulateButton({
  ...
  const buttonLabel = isRunning && !submitting ? "Force populating…" : "Force populate";
