...
// ai-platform replica of PrTable — swaps the per-row sync buttons for
// the ai-platform variants; presentation otherwise identical.

import { ExternalLink } from "lucide-react";
import type { PrListItem, ProcessingStatus } from "@/types/pr-feed";
import ImpactCountBadge from "@/components/pr-feed/ImpactCountBadge";
import PerRowSyncImpactsButton from "@/components/pr-sync-ai-platform/PerRowSyncImpactsButton";
